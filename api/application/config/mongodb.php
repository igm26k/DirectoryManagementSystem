...
$name = VaultSecret::getSecret('MONGO_DB_NAME', 'dimansyMongo');
$user = VaultSecret::getSecret('MONGO_DB_USER', 'dimansyMongo');
$pass = VaultSecret::getSecret('MONGO_DB_PASS', 'dimansyMongo');
